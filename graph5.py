...
graph_title = st.sidebar.text_input('Graph Title', 'Bar Graph with Means and Standard Errors')
x_axis_title = st.sidebar.text_input('X-axis Title', 'Category')
y_axis_title = st.sidebar.text_input('Y-axis Title', 'Value')
